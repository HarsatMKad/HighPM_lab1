...
class MainTest {
    ...
    @Test
    void palindrome() {
        assertTrue(Main.palindrome("salas"));
        assertFalse(Main.palindrome("qwertyq"));
    }
}